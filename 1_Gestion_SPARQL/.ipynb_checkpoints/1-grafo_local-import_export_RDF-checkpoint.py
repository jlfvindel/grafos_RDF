...
# 2. Se crea un nuevo grafo vacío `g2`y se carga con el contenido del fichero anterior: _g2.parse(**location=**'grafo_local-export_RDF.jsonld', format='json-ld')_ De esta forma, `g2` contiene, de momento, las mismas ternas que `g1`.

# %%
fich_salida = 'grafo_local-export_RDF.jsonld'
